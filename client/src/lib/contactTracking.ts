export const CONTACT_TRACKING_HELP = {
  ...
  logContact: "Saving records the current time as the most recent contact and can schedule a new reminder. It never changes the lead status. Change Status separately when the business stage actually changes.",
} as const;
