...
const flows = [
  ...
  },
  {
    ...
    steps: ["Super Admin opens Email settings and selects Super Admin or a technical staff account.", "Enter the SMTP host, port, TLS mode, username, password, sender email, and sender name supplied by that mailbox provider.", "Enable automatic sending, save the settings, then test the connection and send a test email.", "Technical staff can open Email settings to see only their assigned sender email, whether it is active and verified, and run the two test actions.", "Staff cannot view or edit SMTP host, username, password, sender identity, or reply-to settings.", "If required, Super Admin may update the same values directly in the staff_smtp_settings database table."],
