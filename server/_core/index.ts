...
import { backfillFollowUpReminders, backfillLeadDocumentTypes, backfillLeadIdentityKeys, backfillLeadStateCodes, getScheduledJobByTaskUid } from "../db";
...
async function startServer() {
  ...
  await backfillLeadDocumentTypes();
